...
HttpJsonDataProvider::HttpJsonDataProvider(const QString &cacheFile)
    : m_qnam(new QNetworkAccessManager(this)),
      m_cacheFile(cacheFile)
{
}

HttpJsonDataProvider::~HttpJsonDataProvider()
{
    qDebug() << "dtor HDP";
}

void HttpJsonDataProvider::ensureDataAvailable()
{
    ...
    connect(m_qnam, &QNetworkAccessManager::finished, this, &HttpJsonDataProvider::slotFinished);
}

void HttpJsonDataProvider::slotFinished(QNetworkReply *reply)
{
